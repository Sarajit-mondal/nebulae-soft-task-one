...
function Awards() {
  return (
    <div className='max-w-[1180px] mx-auto px-4 md:px-8 mt-20 '>
      ...
      <section className='flex h-screen flex-col md:flex-row items-center justify-between gap-10'>
        ...
        {/* awards gif file */}
        <div className="relative w-full h-[300px]"> {/* Fixed height for the container */}
      <Image
      ...
      />
        ...
        {/* awards */}
          <div className='md:absolute  w-full shadow-md md:w-2/3 md:h-[500px] lg:h-96 bg-white p-6 md:top-2/4 md:-translate-y-2/4 left-10'>
            <h3 className='text-xl '>16 Awards</h3>

            {/* Awards One */}
            <div className='flex gap-12 items-center mt-5'>
                <Image width={60} height={60} src="https://i.ibb.co.com/BL50phf/award-symbol.png" alt='awards one image'/>
                <div>
          ...
          {/* awards company list */}
          <div className='h-96  mt-5 md:h-screen w-full '
  ...
  {companiesLogo.map((company, inx) => (
    <div
      ...
      `}
    >
      <Image height={65} width={65} alt="company logo" src={company} />
    </div>
  ))}
</div>
